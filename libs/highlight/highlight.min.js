...
//highlight.js MATLAB language definition copied from /lib/languages/matlab.js
hljs.registerLanguage("matlab",function matlab(hljs) {
  const TRANSPOSE_RE = '(\'|\\.\')+';
  const TRANSPOSE = {
    relevance: 0,
