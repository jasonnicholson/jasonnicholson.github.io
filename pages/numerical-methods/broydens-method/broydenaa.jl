# broydenaa.jl
# Broyden's Method animation: convergence to solution 1 near (-0.088, 0.827)
# System: f1(x,y) = 1 - 4x + 2x² - 2y² = 0
#         f2(x,y) = -4 + x² + 4y + y² = 0
# Starting point: (0, 1)
# Produces: broydenaa.gif
...
title_str = "Broyden's Method: solution near (-0.088, 0.827)"
...
gif(anim, joinpath(@__DIR__, "broydenaa.gif"); fps=2)
println("Saved: broydenaa.gif")
