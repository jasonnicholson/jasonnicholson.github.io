...
It converges **quadratically** near a simple root but demands $n^2$ new partial-derivative evaluations each step. See [Nonlinear Systems](../nonlinear-systems/index.qmd) for the full treatment.
...
[Julia source](broydenaa.jl)

![Broyden's method animation starting at (0,1): iterates converge superlinearly to the root near (-0.088, 0.827) on the system f1=0 (blue) and f2=0 (red)](broydenaa.gif)
...
[Julia source](broydenbb.jl)

![Broyden's method animation starting at (2.5,-1.5): iterates converge superlinearly to the root near (2.808, -1.665) on the system f1=0 (blue) and f2=0 (red)](broydenbb.gif)
