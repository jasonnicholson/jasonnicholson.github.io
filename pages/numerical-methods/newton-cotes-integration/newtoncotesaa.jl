# newtoncotesaa.jl
# Newton-Cotes animation: Composite Trapezoidal Rule
# Produces: newtoncotesaa.gif
...
gif(anim, joinpath(@__DIR__, "newtoncotesaa.gif"); fps=2)
println("Saved: newtoncotesaa.gif")
