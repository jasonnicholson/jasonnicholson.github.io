# newtonsysaa.jl
# Nonlinear Systems animation: Newton's method converging to Solution 1
# System: f1(x,y) = 1 - 4x + 2x^2 - 2y^3 = 0
#         f2(x,y) = -4 + x^4 + 4y + 4y^4 = 0
# Produces: newtonsysaa.gif
...
sol = pts[end]
println("Solution 1: x = $(round(sol[1], digits=8)), y = $(round(sol[2], digits=8))")
...
gif(anim, joinpath(@__DIR__, "newtonsysaa.gif"); fps=2)
println("Saved: newtonsysaa.gif")
