# aitkenff.jl
# Aitken/Steffensen animation: Example 6
# Convergence comparison: Newton-Raphson vs Steffensen acceleration
# f(x) = x^6 - 7x^4 + 15x^2 - 9,  double root p = sqrt(3) near x=2,  p0 = 1.5
# Produces: aitkenff.gif
...
ylims_err = (-17.0, 1.0)
title_str = "Newton vs Steffensen: f(x) = x⁶−7x⁴+15x²−9  (p₀ = 1.5)"
...
gif(anim, joinpath(@__DIR__, "aitkenff.gif"); fps=2)
println("Saved: aitkenff.gif")
