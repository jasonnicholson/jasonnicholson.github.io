...
![Red is unconverged. The other colors correspond to a root. The o's are the roots.](image-1.png)
...
![Red is unconverged. The other colors correspond to a root. The o's are the roots.](image-2.png)
